...
const ENDING_NARRATIVES: Record<EndingChoice, string[]> = {
  cure: [
    ...
    'Years from now, someone will write the history of what you did, and they will get it wrong. They will call it a mercy. It was a choice. You made it because you believed it was right, and you will never be certain, and that uncertainty is the price of having been the one who decided. The world heals. The scars remain. What is left is what matters.',
  ],
  weapon: [
    ...
    'You did the math. The math was correct. The weapon worked exactly as described, and the silence it left behind is the silence of a problem solved by making most of the problem disappear. Historians will call you a monster or a savior depending on which side of the population curve they stand on. You will call yourself nothing, because you do not owe the dead an explanation. The world survives. It is quieter than it should be. What is left is what matters.',
  ],
  seal: [
    ...
    'You chose to trust the world with its own problems. Some will call it cowardice. Some will call it wisdom. The broadcaster called it "the quietest option" and they were right — it is the choice that makes the least noise and changes the least, and asks the most of everyone who comes after. The world continues. It does not thank you. What is left is what matters.',
  ],
  throne: [
...
export default function EndingScreen({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black font-mono text-amber-400 p-6 overflow-y-auto">
