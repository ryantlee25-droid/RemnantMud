...
export const ITEMS: Record<string, Item> = {
  ...
  // ----------------------------------------------------------
  // H10 boss-unique drop stubs — pending full definitions from H9
  // These stubs satisfy the data-validation test and will be
  // replaced or extended when H9's items merge.
  // ----------------------------------------------------------
