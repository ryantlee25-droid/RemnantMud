...
export const ITEMS: Record<string, Item> = {
  ...
  // ----------------------------------------------------------
  // H9 — New Weapons: Knives / Blades (6)
  // ----------------------------------------------------------

  rusty_knife: {
    id: 'rusty_knife',
    name: 'Rusty Knife',
    description: 'A corroded fixed blade — still cuts, but every wound it opens will need antiseptic.',
    type: 'weapon',
    weight: 1,
    damage: 3,
    value: 5,
  ...
  hunting_knife: {
    id: 'hunting_knife',
    name: 'Hunting Knife',
    description: 'A four-inch drop-point in a leather sheath, made for field dressing game and whatever else the field asks for.',
    type: 'weapon',
    weight: 1,
    damage: 4,
    value: 12,
  ...
  bowie_knife: {
    id: 'bowie_knife',
    name: 'Bowie Knife',
    description: 'Nine-inch clip-point, brass guard, bone handle worn smooth. More knife than most situations need and exactly enough knife for the rest.',
    type: 'weapon',
    weight: 2,
    damage: 5,
    value: 22,
  ...
  kukri: {
    id: 'kukri',
    name: 'Kukri',
    description: 'Forward-curved blade, heavy at the tip — built to chop as much as cut. Drifter traders bring them up from the south.',
    type: 'weapon',
    weight: 2,
    damage: 6,
    value: 30,
  ...
  salter_blade: {
    id: 'salter_blade',
    name: 'Salter Blade',
    description: 'Salt-quenched edge, brine-treated grip wrap. Standard-issue Salter militia sidearm for close work.',
    type: 'weapon',
    weight: 2,
    damage: 6,
    value: 30,
  ...
  lucid_silvered_blade: {
    id: 'lucid_silvered_blade',
    name: 'Lucid Silvered Blade',
    description: 'Moonlit finish on a precision-forged blade — Covenant of Dusk craft, silver-washed and blessed against the Sanguine they once were.',
    type: 'weapon',
    weight: 1,
    damage: 9,
    value: 200,
  ...
  // ----------------------------------------------------------
  // H9 — New Weapons: Pistols (4)
  // ----------------------------------------------------------

  revolver_22: {
    id: 'revolver_22',
    name: '.22 Revolver',
    description: 'A six-shot rimfire revolver chambered in .22 LR — cheap ammo, low recoil, almost no noise. Practical before glamorous.',
    type: 'weapon',
    weight: 1,
    damage: 3,
    value: 10,
  ...
  salter_revolver: {
    id: 'salter_revolver',
    name: 'Salter Revolver',
    description: 'A brine-wiped .38 revolver with a Salt Creek Compact proof mark stamped on the cylinder. Reliable and easy to clean in the field.',
    type: 'weapon',
    weight: 2,
    damage: 5,
    value: 25,
  ...
  drifter_pistol: {
    id: 'drifter_pistol',
    name: 'Drifter Pistol',
    description: 'A road-worn 9mm with a wagon-wheel stamp scratched into the grip — a Drifter trade-mark, passed between dozens of hands on hundreds of roads.',
    type: 'weapon',
    weight: 2,
    damage: 5,
    value: 20,
  ...
  accord_sidearm: {
    id: 'accord_sidearm',
    name: 'Accord Sidearm',
    description: 'A faith-marked 9mm, militia-issued, carrying the Accord peacekeeper stamp — carried by officers and anyone who earned the trust that comes with it.',
    type: 'weapon',
    weight: 2,
    damage: 6,
    value: 35,
  ...
  // ----------------------------------------------------------
  // H9 — New Weapons: Rifles (5)
  // ----------------------------------------------------------

  hunting_rifle: {
    id: 'hunting_rifle',
    name: 'Hunting Rifle',
    description: 'A bolt-action .30-06, iron sights, walnut stock. Built for elk and quietly useful for everything else.',
    type: 'weapon',
    weight: 5,
    damage: 7,
    value: 55,
  ...
  salter_rifle: {
    id: 'salter_rifle',
    name: 'Salter Rifle',
    description: 'Salt Creek Compact issue semi-auto in 7.62, brine-treated against corrosion and proof-marked at the armory.',
    type: 'weapon',
    weight: 5,
    damage: 7,
    value: 60,
  ...
  accord_carbine: {
    id: 'accord_carbine',
    name: 'Accord Carbine',
    description: 'Covenant militia carbine in 5.56 — shorter barrel for room clearance, faith-marked stock, clean trigger pull.',
    type: 'weapon',
    weight: 4,
    damage: 7,
    value: 65,
  ...
  kindling_torchgun: {
    id: 'kindling_torchgun',
    name: 'Kindling Torchgun',
    description: 'An ash-marked rifle with an incendiary-round conversion kit fitted by the Ember\'s gunsmiths — every shot carries a little of the purifying fire.',
    type: 'weapon',
    weight: 5,
    damage: 8,
    value: 95,
  ...
  reclaimer_railgun: {
    id: 'reclaimer_railgun',
    name: 'Reclaimer Railgun',
    description: 'A repurposed electromagnetic accelerator built from salvaged Stacks hardware — junkyard engineering that outperforms anything it has any right to.',
    type: 'weapon',
    weight: 6,
    damage: 9,
    value: 140,
  ...
  // ----------------------------------------------------------
  // H9 — New Weapons: Shotguns (3)
  // ----------------------------------------------------------

  sawed_off: {
    id: 'sawed_off',
    name: 'Sawed-Off Shotgun',
    description: 'Barrel cut to twelve inches, stock shortened to a pistol grip. What it loses in pattern it gains in concealability — and at ten feet none of that math matters.',
    type: 'weapon',
    weight: 3,
    damage: 7,
    value: 40,
  ...
  breaching_shotgun: {
    id: 'breaching_shotgun',
    name: 'Breaching Shotgun',
    description: 'A pump-action 12-gauge with a door-breaching choke and a folding stock — Accord militia entry tool, still earning its keep.',
    type: 'weapon',
    weight: 4,
    damage: 8,
    value: 90,
  ...
  kindling_pyre: {
    id: 'kindling_pyre',
    name: 'Kindling Pyre',
    description: 'A flame-tempered shotgun packed with incendiary shells — ember-forged and ash-marked, made for cleansing more than shooting.',
    type: 'weapon',
    weight: 4,
    damage: 8,
    value: 100,
  ...
  // ----------------------------------------------------------
  // H9 — New Weapons: Blunt / Heavy (4)
  // ----------------------------------------------------------

  sledgehammer: {
    id: 'sledgehammer',
    name: 'Sledgehammer',
    description: 'A ten-pound maul on a thirty-inch handle. Kills doors and whatever stands behind them equally well.',
    type: 'weapon',
    weight: 5,
    damage: 6,
    value: 8,
  ...
  salter_maul: {
    id: 'salter_maul',
    name: 'Salter Maul',
    description: 'A halite-veined iron maul with the Salt Creek proof stamp — brine-cured handle, heavy enough to settle most questions.',
    type: 'weapon',
    weight: 4,
    damage: 6,
    value: 28,
  ...
  accord_hammer: {
    id: 'accord_hammer',
    name: 'Accord Hammer',
    description: 'A militia-issue war hammer, peacekeeper-stamped — built for door breaching and riot control, but a hammer is a hammer.',
    type: 'weapon',
    weight: 3,
    damage: 6,
    value: 25,
  ...
  drifter_club: {
    id: 'drifter_club',
    name: 'Drifter Club',
    description: 'A wagon-spoke wrapped in leather strips and studded with salvaged bolts — road-worn, ugly, and effective.',
    type: 'weapon',
    weight: 3,
    damage: 4,
    value: 6,
  ...
  // ----------------------------------------------------------
  // H9 — New Weapons: Special / Exotic (4)
  // ----------------------------------------------------------

  meridian_railpistol: {
    id: 'meridian_railpistol',
    name: 'MERIDIAN Railpistol',
    description: 'A pristine lab-issue electromagnetic sidearm — pre-Collapse MERIDIAN prototype, built to a military specification that never reached production.',
    type: 'weapon',
    weight: 2,
    damage: 10,
    value: 250,
  ...
  kindling_torch_of_dawn: {
    id: 'kindling_torch_of_dawn',
    name: 'Torch of Dawn',
    description: 'A purified flame-tempered weapon — censer-oiled blade with a burning wick wrapped at the hilt, carried by the Kindling\'s most trusted purifiers.',
    type: 'weapon',
    weight: 2,
    damage: 10,
    value: 220,
  ...
  pre_collapse_combat_knife: {
    id: 'pre_collapse_combat_knife',
    name: 'Pre-Collapse Combat Knife',
    description: 'Military-issue fixed blade, civilian-marked for government testing — pristine finish, civilian proof mark that only means something if you know what program produced it.',
    type: 'weapon',
    weight: 1,
    damage: 9,
    value: 180,
  ...
  red_court_executioner_blade: {
    id: 'red_court_executioner_blade',
    name: 'Executioner\'s Blade',
    description: 'A pen-issued broadsword with a broken-key stamp on the pommel — Red Court executioner gear, carried by those authorized to use it without a hearing.',
    type: 'weapon',
    weight: 3,
    damage: 8,
    value: 95,
  ...
  // ----------------------------------------------------------
  // H9 — New Weapons: Crafted (4) — no recipe, loot/vendor only
  // ----------------------------------------------------------

  crafted_zip_pistol: {
    id: 'crafted_zip_pistol',
    name: 'Zip Pistol',
    description: 'A single-shot pipe-frame pistol in .22 — scrap-tier engineering that fires exactly once before you have to rack the nail and reload.',
    type: 'weapon',
    weight: 1,
    damage: 3,
    value: 7,
  ...
  crafted_pipe_rifle: {
    id: 'crafted_pipe_rifle',
    name: 'Pipe Rifle',
    description: 'A salvaged pipe-stock rifle that chambers .22 and holds four rounds before you need to push more in through the breech.',
    type: 'weapon',
    weight: 3,
    damage: 4,
    value: 12,
  ...
  crafted_machete: {
    id: 'crafted_machete',
    name: 'Crafted Machete',
    description: 'A blank of scavenged steel ground to a working edge on a bench grinder — good enough if you keep it sharp, and sharp is just time and effort.',
    type: 'weapon',
    weight: 2,
    damage: 5,
    value: 18,
  ...
  crafted_club: {
    id: 'crafted_club',
    name: 'Crafted Club',
    description: 'A section of fence post with nails hammered through the striking end — scrap-tier construction that works better than it has any right to.',
    type: 'weapon',
    weight: 3,
    damage: 4,
    value: 5,
  ...
  scrap_helm: {
    id: 'scrap_helm',
    name: 'Scrap Helm',
    description: 'Welded plate scraps and bolted cage wire — protects about as much as the confidence it takes to wear it.',
    type: 'armor',
    weight: 2,
    defense: 0,
    value: 5,
  ...
  leather_hood: {
    id: 'leather_hood',
    name: 'Leather Hood',
    description: 'Hard-boiled leather shaped over a skull form and stitched at the crown — simple head protection that breathes and flexes.',
    type: 'armor',
    weight: 1,
    defense: 1,
    value: 18,
  ...
  salter_helm: {
    id: 'salter_helm',
    name: 'Salter Helm',
    description: 'Brine-marked steel cap with cheek guards and a Salt Creek Compact proof stamp — militia-issue head protection.',
    type: 'armor',
    weight: 2,
    defense: 1,
    value: 25,
  ...
  accord_helm: {
    id: 'accord_helm',
    name: 'Accord Helm',
    description: 'Covenant militia helmet, faith-marked at the brow and fitted with a drop-down cheek guard — worn by peacekeepers who expect to use it.',
    type: 'armor',
    weight: 2,
    defense: 1,
    value: 28,
  ...
  kindling_skullcap: {
    id: 'kindling_skullcap',
    name: 'Kindling Skullcap',
    description: 'Ash-marked leather cap with an ember-tempered steel crown insert — Kindling adherents wear these to the purification rite.',
    type: 'armor',
    weight: 1,
    defense: 2,
    value: 55,
  ...
  drifter_cap: {
    id: 'drifter_cap',
    name: 'Drifter Cap',
    description: 'A road-worn traveler\'s hat with a salt-cured leather brim, inner band reinforced with salvaged metal strips.',
    type: 'armor',
    weight: 1,
    defense: 1,
    value: 20,
  ...
  reclaimer_visor: {
    id: 'reclaimer_visor',
    name: 'Reclaimer Visor',
    description: 'A repurposed face shield from a salvaged welding helmet, padded and strapped to a scrap-tier skull frame.',
    type: 'armor',
    weight: 2,
    defense: 2,
    value: 48,
  ...
  lucid_circlet: {
    id: 'lucid_circlet',
    name: 'Lucid Circlet',
    description: 'A moonlit silver band, dusk-cured and threadbare-lined — Covenant of Dusk courtier wear, refined and unmistakable.',
    type: 'armor',
    weight: 1,
    defense: 3,
    value: 220,
  ...
  // ----------------------------------------------------------
  // H9 — New Armor: Chest (10) — focus tiers 3–5, faction flavor
  // ----------------------------------------------------------

  salter_breastplate: {
    id: 'salter_breastplate',
    name: 'Salter Breastplate',
    description: 'Halite-cured steel plate with a Salt Creek Compact stamp — heavier than it looks and exactly as useful.',
    type: 'armor',
    weight: 5,
    defense: 3,
    value: 55,
  ...
  accord_tabard: {
    id: 'accord_tabard',
    name: 'Accord Tabard',
    description: 'Reinforced canvas tabard over a steel insert, ordained with the Accord seal — peacekeepers wear this when the seal still means something.',
    type: 'armor',
    weight: 4,
    defense: 3,
    value: 50,
  ...
  kindling_vestment: {
    id: 'kindling_vestment',
    name: 'Kindling Vestment',
    description: 'Ember-treated heavy cloth over a flame-tempered chest plate — Kindling purifiers wear this to the fire and through whatever comes after.',
    type: 'armor',
    weight: 4,
    defense: 3,
    value: 60,
  ...
  reclaimer_longcoat: {
    id: 'reclaimer_longcoat',
    name: 'Reclaimer Longcoat',
    description: 'A salvaged engineer\'s duster reinforced with scavenged ceramic panels — junkyard construction that holds up to more than it should.',
    type: 'armor',
    weight: 5,
    defense: 4,
    value: 105,
  ...
  drifter_road_coat: {
    id: 'drifter_road_coat',
    name: 'Drifter Road Coat',
    description: 'A salt-cured wagon-canvas duster with steel shoulder inserts — a Drifter courier\'s armor and weatherbreak in one.',
    type: 'armor',
    weight: 3,
    defense: 2,
    value: 22,
  ...
  red_court_warden_vest: {
    id: 'red_court_warden_vest',
    name: 'Red Court Warden Vest',
    description: 'Warden-issue pen vest, pen-marked at the collar — facility enforcement gear, heavy and intimidating by design.',
    type: 'armor',
    weight: 5,
    defense: 4,
    value: 115,
  ...
  salter_enforcer_plate: {
    id: 'salter_enforcer_plate',
    name: 'Salter Enforcer Plate',
    description: 'Full sea-spray treated steel plate, brine-hardened and proof-stamped — what a Salter enforcer wears when the situation has gone past diplomatic.',
    type: 'armor',
    weight: 6,
    defense: 5,
    value: 200,
  ...
  accord_inquisitor_plate: {
    id: 'accord_inquisitor_plate',
    name: 'Accord Inquisitor Plate',
    description: 'Faith-marked heavy armor, ordained at the Covenant chapel and worn only by inquisitors trusted with the Accord\'s hardest judgments.',
    type: 'armor',
    weight: 6,
    defense: 5,
    value: 210,
  ...
  kindling_purifier_robe: {
    id: 'kindling_purifier_robe',
    name: 'Kindling Purifier Robe',
    description: 'Purified ash-marked linen over censer-oiled plate — worn by the Kindling\'s purifiers at the flame\'s edge, where the fire tests you.',
    type: 'armor',
    weight: 4,
    defense: 5,
    value: 195,
  ...
  meridian_field_suit: {
    id: 'meridian_field_suit',
    name: 'MERIDIAN Field Suit',
    description: 'Lab-issue military-grade field jacket, civilian-marked for off-site trials — pristine condition, as if the Collapse never reached the locker it came from.',
    type: 'armor',
    weight: 3,
    defense: 3,
    value: 75,
  ...
  scrap_leggings: {
    id: 'scrap_leggings',
    name: 'Scrap Leggings',
    description: 'Sheet metal shards wired onto a canvas backing — noisy, heavy, and better than nothing, which is the standard out here.',
    type: 'armor',
    weight: 2,
    defense: 0,
    value: 5,
  ...
  leather_pants: {
    id: 'leather_pants',
    name: 'Leather Pants',
    description: 'Hard-boiled leather trousers, pre-Collapse motorcycle gear, still doing the job they were made for.',
    type: 'armor',
    weight: 2,
    defense: 1,
    value: 18,
  ...
  salter_greaves: {
    id: 'salter_greaves',
    name: 'Salter Greaves',
    description: 'Brine-treated steel shin guards with a Salt Creek Compact stamp — militia-issue lower protection.',
    type: 'armor',
    weight: 2,
    defense: 1,
    value: 22,
  ...
  accord_kilt: {
    id: 'accord_kilt',
    name: 'Accord Kilt',
    description: 'A segmented steel kilt over reinforced canvas — militia-standard lower protection, ordained for field peacekeepers.',
    type: 'armor',
    weight: 3,
    defense: 2,
    value: 50,
  ...
  kindling_robe_lower: {
    id: 'kindling_robe_lower',
    name: 'Kindling Robe (Lower)',
    description: 'Ash-marked linen lower robe with ember-tempered knee guards — worn at the purification rite, designed for the walk through flame.',
    type: 'armor',
    weight: 2,
    defense: 2,
    value: 48,
  ...
  drifter_trousers: {
    id: 'drifter_trousers',
    name: 'Drifter Trousers',
    description: 'Salt-cured canvas travel pants with riveted knee reinforcements — road gear, built for distance and abuse.',
    type: 'armor',
    weight: 1,
    defense: 1,
    value: 20,
  ...
  scrap_boots: {
    id: 'scrap_boots',
    name: 'Scrap Boots',
    description: 'Salvaged rubber soles wired to canvas uppers — crude but they keep the ground off your feet, which is the minimum requirement.',
    type: 'armor',
    weight: 1,
    defense: 0,
    value: 5,
  ...
  hunting_boots: {
    id: 'hunting_boots',
    name: 'Hunting Boots',
    description: 'Pre-Collapse lace-up leather boots, still waterproofed, with lug soles that grip uneven ground.',
    type: 'armor',
    weight: 2,
    defense: 1,
    value: 20,
  ...
  salter_boots: {
    id: 'salter_boots',
    name: 'Salter Boots',
    description: 'Sea-spray treated leather field boots, halite-soled against corrosion — Salt Creek militia issue, built for the long march.',
    type: 'armor',
    weight: 2,
    defense: 1,
    value: 25,
  ...
  accord_boots: {
    id: 'accord_boots',
    name: 'Accord Boots',
    description: 'Militia-issue reinforced boots with a faith-marked buckle — Accord peacekeepers wear these from their first patrol to their last.',
    type: 'armor',
    weight: 2,
    defense: 1,
    value: 28,
  ...
  kindling_sandals: {
    id: 'kindling_sandals',
    name: 'Kindling Sandals',
    description: 'Flame-tempered leather soles on an ember-marked strap — worn by Kindling adherents as a reminder that the ground was always burning.',
    type: 'armor',
    weight: 1,
    defense: 1,
    value: 40,
  ...
  drifter_treads: {
    id: 'drifter_treads',
    name: 'Drifter Treads',
    description: 'Road-worn traveler boots with a wagon-track sole pattern — every Drifter courier\'s first investment and last replacement.',
    type: 'armor',
    weight: 2,
    defense: 1,
    value: 22,
