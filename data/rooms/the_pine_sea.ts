...
export const THE_PINE_SEA_ROOMS: Room[] = [
  {
    ...
    cycleGate: 2,
    description: 'The forest begins at a line so distinct it reads as a geological boundary: open ground ends, and ten thousand pines begin, packed close enough that their canopy closes twenty yards in. The air changes in a single step — cooler, thick with resin, the smell of sap and wet bark and centuries of needle decay compressed into something you breathe like incense. Your boots crunch duff that has been accumulating since before the concept of Colorado. The light filters green-gold through the canopy, diffused, churchlike. Inside the tree line: quiet. Not the quiet of the Dust, which is absence. This is the quiet of something that was here before you and will be here long after.',
...

  {
    ...
    description: 'The canopy opens and the sky returns — an alpine meadow ringed by pines so tall they frame it like the walls of a bowl carved by glaciers ten thousand years before anyone named them. Grass grows in the short window between snowmelt and first freeze, and the elk herd moves through it: twenty, thirty animals, unhurried, their hooves pressing paths into ground that has known this weight since the Pleistocene. The bulls carry antlers in velvet. A calf stays close to its mother. The resin smell gives way to wet grass and cold earth. There is nothing wrong with this scene. Nothing at all. You had forgotten that was possible.',
...

  {
    ...
    description: 'A timber cabin set back from a logging road that last saw a truck in 2030, already half-reclaimed — pine needles thick on the metal roof, roots nudging the foundation stones, the forest closing in with the patient certainty of something that was never really interrupted. The cabin is built to last — squared logs, tight chinking — but the pines around it are built to outlast. Inside: a potbelly stove, a cot frame, supply shelves stocked by previous occupants with the informal reciprocity of the backcountry tradition. The air smells like old wood and cold resin. The log book on the shelf has thirty-eight entries from thirty-eight different visitors over seven years. You are thirty-nine.',
