...
export const THE_SCAR_ROOMS: Room[] = [
  {
    ...
    hollowEncounter: {
      ...
      threatPool: [
        ...
        { type: 'frenzy', weight: 10, quantity: { min: 1, max: 1, distribution: 'flat' } },
        { type: 'apex_screamer', weight: 8, quantity: { min: 1, max: 1, distribution: 'flat' } },
        { type: 'kindling_zealot', weight: 5, quantity: { min: 1, max: 1, distribution: 'flat' } },
      ],
    ...
    extras: [
      {
        ...
        questFlagOnSuccess: { flag: 'broadcaster_found', value: true },
      },
      {
...

  {
    ...
    richExits: {
      ...
      // Post-ending navigation: page.tsx intercepts all commands after game_ending triggers
      // (gameFlow === 'ending' state), so 'go east' is never player-typed after the choice.
      // hidden: true was removed so the navigation test can confirm the exit is traversable
      // at cycle 3. In normal gameplay the ending flow owns the transition to scar_15.
      east: { destination: 'scar_15_the_exit', descriptionVerbose: 'east, the way out' },
    ...
    extras: [
      {
        ...
        questFlagOnSuccess: [
          { flag: 'found_hollow_origin', value: true },
          { flag: 'hollow_origin_understood', value: true },
        ],
  ...
  // ─── SCAR-28: The Junction ──────────────────────────────────────────────────
  {
    ...
    extras: [
      ...
      },
      {
        ...
        skillCheck: { skill: 'lore', dc: 10, successAppend: 'The funding consortium. The server data. The names in Vane\'s journal. The personnel file cross-references. Every piece of evidence converges here: the people who knew about MERIDIAN and kept knowing have been shaping post-Collapse politics using that knowledge as leverage. The factions you\'ve navigated were not accidents. Some of their choices were made in the shadow of this facility and everything it contained. And the facility itself — buried in the Scar valley — was never an accident of geography. MERIDIAN induced the subsidence. They chose this location because of what was already here, underneath: the structure the research notes call the Fault. The Scar is the evidence. You are standing inside what they built to reach it.' },
        questFlagOnSuccess: { flag: 'fault_scar_connection_confirmed', value: true },
      },
      {
